...
class TradeEnv(ta.Env):
    ...
    def _generate_player_prompt(self, player_id: int, game_state: Dict[int, Any]) -> str:
        ...
        prompt = (
            ...
            "You have some resources, and your task is to trade with your opponent such that the total value of your and your opponent's combined resources increases.\n"
